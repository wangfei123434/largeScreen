import {
  ...
  warn
} from "./chunk-4BRYM5XH.js";
import {
  WeakMap_default,
  brushSingle,
  requestAnimationFrame_default
} from "./chunk-IK2EGILB.js";
import {
  $override,
  Animator_default,
...
function clientToLocal(el, e, out, calculate) {
  ...
  } else if (env_default.browser.firefox && env_default.browser.version < "39" && e.layerX != null && e.layerX !== e.offsetX) {
    out.zrX = e.layerX;
    out.zrY = e.layerY;
...
var ZRender = function() {
  ...
  ZRender2.prototype.pathToImage = function(e, dpr) {
...
var IntervalScale = function(_super) {
  ...
  IntervalScale2.prototype.niceExtent = function(opt) {
    ...
    var interval = this._interval;
    if (!opt.fixMin) {
      extent[0] = roundNumber2(Math.floor(extent[0] / interval) * interval);
    }
    if (!opt.fixMax) {
      extent[1] = roundNumber2(Math.ceil(extent[1] / interval) * interval);
    }
  };
...
*/
//# sourceMappingURL=chunk-TGVFSLLF.js.map
