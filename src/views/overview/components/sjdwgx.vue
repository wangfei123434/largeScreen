<template>
  <div class="l1-box">
    <div class="title">数据对外共享服务(条)</div>
    <div class="echarts-box">
      <v-chart class="chart" :option="option" ref="chartRef" style="width:500px"/>
...
export default defineComponent({
  ...
  props: ['data'],
  setup(props) {
    console.log('props--数据对外共享', props.data)
    const state = reactive({
      echartsData: [props.data.dataCityBigDataPlatform, props.data.dataWuhanOpenPlatform, props.data.dataOtherChannels]
    })
    const offsetX = 20
    const offsetY = 10
    // 绘制左侧面
